...
new class extends Component {
    ...
    public function save() {
        $validated = $this->validate([
            ...
            'document_number' => 'required|max:255|min:3|unique:suppliers,document_number',
            'phone' => 'max:255|min:3',
        ...
        <x-card>
            <form wire:submit.prevent="save">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 py-4">
                    Registre la información del proveedor.
                </p>
                <div class="border-t border-gray-200 dark:border-gray-600"></div>

                @include('livewire.pages.admin.suppliers.partials.form', ['showForm' => true, 'editForm' => false])
