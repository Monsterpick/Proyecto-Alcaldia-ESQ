                ...
                <tbody>
                    ...
                    {{-- @forelse($products as $index => $product)
                        <tr class="border-b">
                            ...
                            <td class="py-2 px-4">{{ $product['price'] * $product['quantity'] }}</td>
                            <td class="py-2 px-4">
                                <x-mini-button label="Eliminar" wire:click="removeProduct({{ $product['id'] }})" icon="trash" rounded red />
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td class="text-center text-gray-500 py-4" colspan="5">No hay productos agregados</td>
                        </tr>
                    @endforelse --}}
